...
// TASK | IMAGES
    ...
    // ONE-OFF | ART-DIRECTED CROPS
    // For manually cropped/resized revisions that shouldn't run through the
    // full courses pipeline. Drop finished .tiff files into
    // _files/images/_one-off/ and run `gulp compressOneOff` — this compresses
    // to webp/avif at native size (no resize) and writes to
    // _files/images/_one-off/compressed/, keeping originals untouched.
